...
Navigate to the `Adlists` tab. You can find or create your own blocklists to suit your needs and preferences. I use several lists found on [https://firebog.net/](https://firebog.net/), a blocklist collection maintained by @WaLLy3K on GitHub.
