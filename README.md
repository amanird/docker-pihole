...
*Note: These instructions will be based on using a Raspberry Pi for the server. Alternatively you may use an old PC, virtual machine, or hypervisor (Proxmox is a very popular option).*
