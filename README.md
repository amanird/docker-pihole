...
*Note: These instructions are intended for using  a Raspberry Pi as the server. Alternatively, you can use an old PC, VM, or a hypervisor (such as Proxmox, which is a popular).*
